...
public class SuperHeroTest extends BaseTest {
	...
	public void _01_010_post_WhenValidJSON() {
		logger.debug("CALLING _01_010_post_WhenValidJSON() - BEGIN");
		// Code Details = 201
		// Response headers =
		...
		logger.debug("CALLING _01_010_post_WhenValidJSON() - END");
	}
	...
	public void _01_020_post_WhenInValidJSON() {
		logger.debug("CALLING _01_020_post_WhenInValidJSON() - BEGIN");
		// Code Details = 500
		// Response body = 
		// {
	...
	public void _02_020_get_SuperHerosByFirstName_WhenValid() {
		logger.debug("CALLING _02_020_get_SuperHerosByFirstName_WhenValid() - BEGIN");
		prepareGet(String.format(SUPERHEROS_BY_FIRSTNAME, SUPERHERO_NAMES_FIRST_VALID))
		.statusCode(SC_OK)
		//.time(lessThan(ENDPOINT_RESPONSE_TIME))
		.body("$", hasSize(2))
		.body(matchesJsonSchemaInClasspath(JSON_SCHEMA_PATH_SUPERHEROS));
		logger.debug("CALLING _02_020_get_SuperHerosByFirstName_WhenValid() - END");
	}
	
	@Test
	/** Expected result: A valid empty JSON array */
	public void _02_030_get_SuperHerosByFirstName_WhenInValid() {
		logger.debug("CALLING _02_030_get_SuperHerosByFirstName_WhenInValid() - BEGIN");
		prepareGet(String.format(SUPERHEROS_BY_FIRSTNAME, SUPERHERO_NAMES_FIRST_INVALID))
		.statusCode(SC_OK)
		//.time(lessThan(ENDPOINT_RESPONSE_TIME))
		.body("$", hasSize(0))
		.body(matchesJsonSchemaInClasspath(JSON_SCHEMA_PATH_SUPERHEROS));
		logger.debug("CALLING _02_030_get_SuperHerosByFirstName_WhenInValid() - END");
	}
	...
	public void _02_040_get_SuperHerosByLastName_WhenValid() {
		logger.debug("CALLING _02_040_get_SuperHerosByLastName_WhenValid() - BEGIN");
		prepareGet(String.format(SUPERHEROS_BY_LASTNAME, SUPERHERO_NAMES_LAST_VALID))
		.statusCode(SC_OK)
		//.time(lessThan(ENDPOINT_RESPONSE_TIME))
		.body("$", hasSize(2))
		.body(matchesJsonSchemaInClasspath(JSON_SCHEMA_PATH_SUPERHEROS));
		logger.debug("CALLING _02_040_get_SuperHerosByLastName_WhenValid() - END");
	}
	
	@Test
	/** Expected result: A valid empty JSON array */
	public void _02_050_get_SuperHerosByLastName_WhenInValid() {
		logger.debug("CALLING _02_050_get_SuperHerosByLastName_WhenInValid() - BEGIN");
		prepareGet(String.format(SUPERHEROS_BY_LASTNAME, SUPERHERO_NAMES_LAST_INVALID))
		.statusCode(SC_OK)
		//.time(lessThan(ENDPOINT_RESPONSE_TIME))
		.body("$", hasSize(0))
		.body(matchesJsonSchemaInClasspath(JSON_SCHEMA_PATH_SUPERHEROS));
		logger.debug("CALLING _02_050_get_SuperHerosByLastName_WhenInValid() - END");
	}
	...
	public void _02_060_get_SuperHeroById_WhenValid() {
		logger.debug("CALLING _02_060_get_SuperHeroById_WhenValid() - BEGIN");
	...
	public void _02_070_get_SuperHeroById_WhenInvalid() {
		logger.debug("CALLING _02_070_get_SuperHeroById_WhenInvalid() - BEGIN");
		// {
		...
		logger.debug("CALLING _02_070_get_SuperHeroById_WhenInvalid() - END");
	}
	...
	public void _02_080_get_SuperHeroBySuperHeroName_WhenValid() {
		logger.debug("CALLING _02_080_get_SuperHeroBySuperHeroName_WhenValid() - BEGIN");
	...
	public void _02_090_get_SuperHeroBySuperHeroName_WhenInValid() {
		logger.debug("CALLING _02_090_get_SuperHeroBySuperHeroName_WhenInValid() - BEGIN");
		// {
	...
	@Test
	/** Expected result: A server exception is thrown and the response body contains its description */
	public void _03_010_put_WhenFoundByIdAndInValidJSON() {
		logger.debug("CALLING _03_010_put_WhenFoundByIdAndInValidJSON() - BEGIN");
		//JPA Exception
		...
		logger.debug("CALLING _03_010_put_WhenFoundByIdAndInValidJSON() - END");
	}
	...
	public void _03_020_put_WhenNotFoundByIdAndValidJSON() {
		logger.debug("CALLING _03_020_put_WhenNotFoundByIdAndValidJSON() - BEGIN");
		// Code Details = 404	
		// Response body = 
		// {
		...
		logger.debug("CALLING _03_020_put_WhenNotFoundByIdAndValidJSON() - END");
	}
	
	@Test
	/** Expected result: A server exception is thrown and the response body contains its description */
	public void _03_030_put_WhenNotFoundByIdAndInValidJSON() {
		logger.debug("CALLING _03_030_put_WhenNotFoundByIdAndInValidJSON() - BEGIN");
		// Code Details = 404	
		// Response body = 
		// {
		//   "timestamp": "2018-Nov-27 06:58:11",
		...
		//.time(lessThan(ENDPOINT_RESPONSE_TIME))
		.body(containsString("No registered Super Hero with ID = " + SUPERHERO_ID_INVALID + " available for update"));
		logger.debug("CALLING _03_030_put_WhenNotFoundByIdAndInValidJSON() - END");
	}
	...
	public void _04_010_delete_SuperHeroById_WhenUnAuthorized() {
		logger.debug("CALLING _04_010_delete_SuperHeroById_WhenUnAuthorized() - BEGIN");		
		prepareDelete(String.format(SUPERHERO_BY_ID, superHeroNew.get("id").getAsLong()))
		//.time(lessThan(ENDPOINT_RESPONSE_TIME))
		.statusCode(SC_UNAUTHORIZED)
		.body(containsString("Unauthorized"));
		logger.debug("CALLING _04_010_delete_SuperHeroById_WhenUnAuthorized() - END");
	}
	...
	public void _04_020_delete_SuperHeroById_WhenValid_AndAuthorized() {
		logger.debug("CALLING _04_020_delete_SuperHeroById_WhenValid_AndAuthorized() - BEGIN");
		// Code Details = 204
		// Response headers = 
		// cache-control: no-cache, no-store, max-age=0, must-revalidate 
		...
		logger.debug("CALLING _04_020_delete_SuperHeroById_WhenValid_AndAuthorized() - END");
	}
	...
	public void _04_030_delete_SuperHeroById_WhenInValidOrAlreadyDeleted_AndAuthorized() {
		logger.debug("CALLING _04_030_delete_SuperHeroById_WhenInValidOrAlreadyDeleted_AndAuthorized() - BEGIN");
		// Code Details = 500
		// Response body = 
		// {
		...
		logger.debug("CALLING _04_030_delete_SuperHeroById_WhenInValidOrAlreadyDeleted_AndAuthorized() - END");
	}
}
