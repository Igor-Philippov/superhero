...
public class MissionTest extends BaseTest {
	...
	public void _02_010_get_Missions() {
		logger.debug("CALLING _02_010_get_Missions() - BEGIN");
		prepareGet(MISSIONS)
        .statusCode(SC_OK)
        //.time(lessThan(ENDPOINT_RESPONSE_TIME))
        .body(matchesJsonSchemaInClasspath(JSON_SCHEMA_PATH_MISSIONS))
        .body("$", not(empty()));
		logger.debug("CALLING _02_010_get_Missions() - END");
	}
	...
	public void _02_020_get_MissionsCompleted() {
		logger.debug("CALLING _02_020_get_MissionsCompleted() - BEGIN");
		prepareGet(MISSIONS_COMPLETED)
		.statusCode(SC_OK)
        //.time(lessThan(ENDPOINT_RESPONSE_TIME))
        .body(matchesJsonSchemaInClasspath(JSON_SCHEMA_PATH_MISSIONS));
		logger.debug("CALLING _02_020_get_MissionsCompleted() - END");
	}
	...
	public void _02_030_get_MissionsDeleted_WhenAuthorised() {
		logger.debug("CALLING _02_030_get_MissionsDeleted_WhenAuthorised() - BEGIN");
		prepareGetSecured(MISSIONS_DELETED)
		.statusCode(SC_OK)
		//.time(lessThan(ENDPOINT_RESPONSE_SECURED))
		.body(matchesJsonSchemaInClasspath(JSON_SCHEMA_PATH_MISSIONS))
        .body("$", not(empty()));
		logger.debug("CALLING _02_030_get_MissionsDeleted_WhenAuthorised() - END");
	}
	...
	public void _02_040_get_MissionsDeleted_WhenUnAuthorised() {
		logger.debug("CALLING _02_040_get_MissionsDeleted_WhenUnAuthorised() - BEGIN");
		prepareGet(MISSIONS_DELETED)
		.statusCode(SC_UNAUTHORIZED)
		//.time(lessThan(ENDPOINT_RESPONSE_SECURED))
		.body(containsString("Unauthorized"));
		logger.debug("CALLING _02_040_get_MissionsDeleted_WhenUnAuthorised() - END");
	}
	
	@Test
	/** Expected result: Mission as JSON object retrieved by ID */
	public void _02_050_get_MissionById_WhenValid() {
		logger.debug("CALLING _02_050_get_MissionById_WhenValid() - BEGIN");
	...
	public void _02_060_get_MissionById_WhenInvalid() {
		logger.debug("CALLING _02_060_get_MissionById_WhenInvalid() - BEGIN");
		// {
		...
		logger.debug("CALLING _02_060_get_MissionById_WhenInvalid() - END");
	}
	...
	public void _02_070_get_MissionByName_WhenValid() {
		logger.debug("CALLING _02_070_get_MissionByName_WhenValid() - BEGIN");
	...
	public void _02_080_get_MissionByName_WhenInvalid() {
		logger.debug("CALLING _02_080_get_MissionByName_WhenInvalid() - BEGIN");
	...
	public void _02_090_put_WhenFoundByIdAndValidJSON() {
		logger.debug("CALLING _02_090_put_WhenFoundByIdAndValidJSON() - BEGIN");
		// Code Details = 200	
		...
		.body(matchesJsonSchemaInClasspath(JSON_SCHEMA_PATH_MISSION))
        .body("$", not(empty()));
		logger.debug("CALLING _02_090_put_WhenFoundByIdAndValidJSON() - END");
	}
	...
	public void _04_010_delete_MissionById_WhenUnAuthorized() {
		logger.debug("CALLING _04_010_delete_MissionById_WhenUnAuthorized() - BEGIN");		
		prepareDelete(String.format(MISSION_BY_ID, missionNew.get("id").getAsLong()))
		//.time(lessThan(ENDPOINT_RESPONSE_TIME))
		.statusCode(SC_UNAUTHORIZED)
		.body(containsString("Unauthorized"));
		logger.debug("CALLING _04_010_delete_MissionById_WhenUnAuthorized() - END");
	}
	...
	public void _04_020_delete_MissionById_WhenValid_AndAuthorized() {
		logger.debug("CALLING _04_020_delete_MissionById_WhenValid_AndAuthorized() - BEGIN");
		// Code Details = 204
		// Response headers = 
		//  cache-control: no-cache, no-store, max-age=0, must-revalidate 
		...
		logger.debug("CALLING _04_020_delete_MissionById_WhenValid_AndAuthorized() - END");
	}
	...
	public void _04_030_delete_MissionById_WhenInValidOrAlreadyDeleted_AndAuthorized() {
		logger.debug("CALLING _04_030_delete_MissionById_WhenInValidOrAlreadyDeleted_AndAuthorized() - BEGIN");
		// Code Details = 404
		// Response body = 
		// {
		...
		logger.debug("CALLING _04_030_delete_MissionById_WhenInValidOrAlreadyDeleted_AndAuthorized() - END");
	}
}
